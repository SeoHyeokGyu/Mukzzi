...
- **다양한 메뉴 결정 방식**: 랜덤 룰렛, 상황별 필터로 메뉴 선택 자체를 즐거운 경험으로
- **캐릭터 성장 시스템**: 식사 기록이 곧 먹찌 육성 — 경험치 획득, 레벨업, 영양소 기반 파츠 조합 성장
...
- 체형, 근육, 피부색, 표정 (각 5단계) 조합으로 625가지 외형 + 악세서리 (레벨별 해금)
...
┌─────────────────────────────────────────────────┐
│              Service Layer                      │
│  비즈니스 로직, 영양소 계산, 파츠 조합 판정, 경험치 관리 │
└─────────────────────────────────────────────────┘
                      ↓ Model
┌─────────────────────────────────────────────────┐
...
- 캐릭터 성장 (경험치, 레벨업, 파츠 조합 625가지, 패널티)
- 먹부림 캘린더 + 먹찌 도감
- 영양 밸런스 피드백
- 친구 먹찌 프로필 방문
- 회원가입 / 로그인 (JWT + 소셜)
